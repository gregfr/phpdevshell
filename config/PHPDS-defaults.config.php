...
$master_database = array(
    ...
    /** Connector class to use to handle the actual database communications */
    'connector' => 'PHPDS_pdoConnector'
);
...
/**
 * If provided, this will be the base for the canonical URL of the pages
 * @type string
 * @date 20160112 (greg) added
 * @since 3.5
 */
$configuration['canonical_root'] = '';
...
/**
 * A customizable list of keywords use by the framework
 * In case you want to change (localize...) them
 *
 * @since 3.5
 * @date 20151027 (1.0) (greg) added
 */
$configuration['keywords'] = array(
	'logout' => 'logout',		// added 20151027 (3.5)
	'login' => 'login',		// added 20151027 (3.5)
);
