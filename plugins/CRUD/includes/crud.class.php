<?php
     ...
     * Basic ORM plugin.
     *
     * @date 20172425 (1.1) (greg) Removed dependency on RedBean
     *
    ...
    class crud extends PHPDS_dependant
    {
         ...
         * Class constructor
         *
         * If you want your instance to use an ORM instance, pass it here
         *
         ...
         *
         * @date 20172925 (1.1) (greg) Removed dependendy on RedBean
         *
         * @param string $val
         * @param int $join_id
