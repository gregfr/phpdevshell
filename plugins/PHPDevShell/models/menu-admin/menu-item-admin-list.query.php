 ...
 * @version 1.0.1
 *
 * @date 20160926 (1.0.1) (greg) removed disabled state of lines corresponding to an inaccessible node (lp#... TODO)
 *
 * @see TODO
 *
 */
class PHPDS_listMenusQuery extends PHPDS_query
{
	...
	public function invoke($parameters = null)
	{
		...
		foreach ($menu_array->menuArray as $select_menu_items_array) {
            ...
            // this is removed because the whole line was disabled: lp#TODO
