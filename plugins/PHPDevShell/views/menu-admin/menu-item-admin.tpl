        ...
        <div class="column grid_4">
            ...
            <p>
                <label>{_e('User Role Permission - Who can access this node?')}
                    ...
                    <input type="checkbox" name="inherit_permissions" id="inherit_permissions" {if ($inherit_rights) }checked{/if}/>
                        <label for="inherit_permissions">Inherit permissions from parent</label>
                </label>
            </p>
            <p>
                <label>{_e('Theme')}
