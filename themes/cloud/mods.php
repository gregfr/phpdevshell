...
class themeMods extends PHPDS_dependant
{
    ...
    /**
     * Generates a html snippet for including a delayed CSS file
     *
     * @date 20150324 (1.0) (greg) added
     * @version 1.0
     ...
     */
    public function cssFileDelayed($href, $media)
    {
        return '<link rel="stylesheet" data-aload="' . $href . '" media="' . $media . '" />
            ';
    }
...
HTML;
    ...
    public function httpmenuRedirect($url, $time)
    {
        return '
...
HTML;
    ...
    public function outputCanonicalURL($base, $page)
    {
        if (substr($base, -1) != '/') {
            $base .= '/';
        }
