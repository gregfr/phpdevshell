 ...
 * @param mixed $reference -- used by internal recursive call (no known external value)
 */
 ...
 *
 * @date 20150228 (1.0.1) (greg) minor refactoring
 * @version 1.0.1
 * @author Jason
 *
 * @param string $string
...
/**
 * Use the Location header to send the browser to a new page
 *
 * @version 1.0
 * @since 3.5.0
 * @param string $url
