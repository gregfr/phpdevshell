<?php
    ...
    /**
     * One of the major classes in PHPDeVShell, deals with Navigation: URL, Menus, request parsing...
     *
     * A single instance of this class is created during a request.
     *
     */
    class PHPDS_navigation extends PHPDS_dependant
    {
         ...
         *
         * @param int|string|false $menu_id
         */
         ...
         *
         * @param mixed $menu_id The menu id or menu file location to create a url from.
         ...
         * @date 20100109
         *
         * @param string|null $uri The URI to parse, it not provided, use the current request
         *
         * @author Ross Kuyper
         * @author greg <greg@phpdevshell.org>
         */
         ...
         *
         * @param integer $extended_menu_id
         * @return integer
         */
        public function extendMenuLoop($extended_menu_id)
        {
            $navigation = $this->navigation;
            $result = '0'; // a non-existent node ID which will be replace by the default home page
            ...
            if (!empty($extend_more) && ($extended_menu_id != $navigation[$extend_more]['extend'])) {
                ...
                $result = $this->extendMenuLoop($extend_more);
            } else {
                ...
                if (!empty($navigation[$extended_menu_id]['extend'])) {
                    if (!empty($navigation[$extended_menu_id]['parent_menu_id'])) {
                        ...
                        $result = $this->extendMenuLoop($navigation[$extended_menu_id]['parent_menu_id']);
                    } else {
                        // We now have no other choice but to show default home page.
                        $result = '0';
                    }
                } else {
                    $result = $extended_menu_id;
                }
            }
            return $result;
        }
